## 10. How to Talk About This Project in an Interview
...
This repository contains all the files referenced above; refer to each file in the GitHub tree for implementation details.
